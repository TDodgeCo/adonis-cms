...
class QuoteSchema extends Schema {
  up() {
    this.create('quotes', table => {
      ...
      table.string('wainscot').defaultTo('None')
      ...
      table
        .integer('roof_snow_load')
        .unsigned()
        .defaultTo(0)
      table
        .integer('ground_snow_load')
        .unsigned()
        .defaultTo(0)
      table
        .integer('wind_load')
      ...
      table.integer('accessories_cost').unsigned()
      table.integer('engineering_cost').unsigned()
